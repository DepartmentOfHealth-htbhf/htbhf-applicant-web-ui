...
const runGuidancePageTest = async (results) => {
  try {
    ...
    console.log('Guidance page testing', HOW_IT_WORKS_URL)
    results.push(await pa11y(HOW_IT_WORKS_URL))
    console.log('Guidance page testing', ELIGIBILITY_URL)
    results.push(await pa11y(ELIGIBILITY_URL))
    console.log('Guidance page testing', WHAT_YOU_GET_URL)
    results.push(await pa11y(WHAT_YOU_GET_URL))
    console.log('Guidance page testing', WHAT_YOU_CAN_BUY_URL)
    results.push(await pa11y(WHAT_YOU_CAN_BUY_URL))
    console.log('Guidance page testing', USING_YOUR_CARD_URL)
    results.push(await pa11y(USING_YOUR_CARD_URL))
    console.log('Guidance page testing', APPLY_URL)
    results.push(await pa11y(APPLY_URL))
    console.log('Guidance page testing', REPORT_A_CHANGE_URL)
