Feature: Change answer for 'Do you have children under four years old?'
  ...
  Scenario: I can change my answer to yes for 'Do you have children under four years old?' from the check details page
  ...
  Scenario: I can change my answer to no for 'Do you have children under four years old?' from the check details page
    When I choose to change my answer to Do you have children
