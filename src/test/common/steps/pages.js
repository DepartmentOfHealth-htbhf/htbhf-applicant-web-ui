...
const NationalInsuranceNumber = require('../page/national-insurance-number')
...
class Pages {
  ...
  initialise () {
    ...
    this.nationalInsuranceNumber = new NationalInsuranceNumber(this.driver)
    ...
    this.allPages = [this.name, this.nationalInsuranceNumber, this.dateOfBirth, this.areYouPregnant, this.manualAddress, this.phoneNumber,
